...
async def start(client, message):
    ...
    k = await msg.reply("<b><u>⚠️⚠️ 𝐈𝐌𝐏𝐎𝐑𝐓𝐀𝐍𝐓 ⚠️⚠️</u></b>\n\nᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ, ᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ɪɴ 𝟭𝟬 ⏳ ᴍɪɴᴜᴛᴇꜱ. ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴛᴏ ᴀ ꜰʀɪᴇɴᴅ ⏩ ᴏʀ ꜱᴀᴠᴇᴅ ᴍᴇꜱꜱᴀɢᴇ ꜰᴏʟᴅᴇʀ. ᴛʜᴇɴ ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ⚡ ᴛʜᴇ ᴍᴏᴠɪᴇ ꜰʀᴏᴍ ᴛʜᴇʀᴇ. ᴛʜᴇɴ ᴛʜᴇ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴡɪʟʟ ɴᴏᴛ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ᴛʜᴇʀᴇ. \n\nकॉपीराइट के कारण यह मूवी फ़ाइल 5 ⏳ मिनट में ऑटोमैटिक डिलीट हो जायेगी कृपया इस मूवी फ़ाइल को किसी फ्रैंड ⏩ या Saved Message folder में forward करे । फिर वहां से मूवी डाउनलोड ⚡ करना शुरू करें। फिर वहा पर मूवी फाइल ऑटोमैटिक डिलीट नही होगी ।e</i></b>",quote=True)
    await asyncio.sleep(300)
    await msg.delete()
    await k.edit_text("<b>Your File/Video is successfully deleted!!!\n\nClick below button to get your deleted file 👇</b>",reply_markup=InlineKeyboardMarkup(btn))
    return   
