...
async def start(client, message):
    ...
    if not files_:
        ...
        try:
            ...
            title = '@cinewood_1_bot  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
            ...
            k = await msg.reply("<b><u>⚠️⚠️ 𝐈𝐌𝐏𝐎𝐑𝐓𝐀𝐍𝐓 ⚠️⚠️</u></b>\n\nᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ, ᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ɪɴ 𝟭𝟬 ⏳ ᴍɪɴᴜᴛᴇꜱ. ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴛᴏ ᴀ ꜰʀɪᴇɴᴅ ⏩ ᴏʀ ꜱᴀᴠᴇᴅ ᴍᴇꜱꜱᴀɢᴇ ꜰᴏʟᴅᴇʀ. ᴛʜᴇɴ ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ⚡ ᴛʜᴇ ᴍᴏᴠɪᴇ ꜰʀᴏᴍ ᴛʜᴇʀᴇ. ᴛʜᴇɴ ᴛʜᴇ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴡɪʟʟ ɴᴏᴛ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ᴛʜᴇʀᴇ. \n\nकॉपीराइट के कारण यह मूवी फ़ाइल 𝟭𝟬 ⏳ मिनट में ऑटोमैटिक डिलीट हो जायेगी कृपया इस मूवी फ़ाइल को किसी फ्रैंड ⏩ या Saved Message folder में forward करे । फिर वहां से मूवी डाउनलोड ⚡ करना शुरू करें। फिर वहा पर मूवी फाइल ऑटोमैटिक डिलीट नही होगी ।</i></b>",quote=True)
            await asyncio.sleep(600)
            await msg.delete()
    ...
    files = files_[0]
    title = '@cinewood_1_bot  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), files.file_name.split()))
    ...
    if CUSTOM_FILE_CAPTION:
        try:
            ...
            f_caption=f_caption
    if f_caption is None:
        f_caption = f"@cinewood_1_bot  {' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), files.file_name.split()))}"
    if not await check_verification(client, message.from_user.id) and VERIFY == True:
        btn = [[
            InlineKeyboardButton("Verify", url=await get_token(client, message.from_user.id, f"https://telegram.me/{temp.U_NAME}?start="))
        ]]
    ...
    k = await msg.reply("<b><u>⚠️⚠️ 𝐈𝐌𝐏𝐎𝐑𝐓𝐀𝐍𝐓 ⚠️⚠️</u></b>\n\nᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ, ᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ɪɴ 𝟭𝟬 ⏳ ᴍɪɴᴜᴛᴇꜱ. ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴛᴏ ᴀ ꜰʀɪᴇɴᴅ ⏩ ᴏʀ ꜱᴀᴠᴇᴅ ᴍᴇꜱꜱᴀɢᴇ ꜰᴏʟᴅᴇʀ. ᴛʜᴇɴ ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ⚡ ᴛʜᴇ ᴍᴏᴠɪᴇ ꜰʀᴏᴍ ᴛʜᴇʀᴇ. ᴛʜᴇɴ ᴛʜᴇ ᴍᴏᴠɪᴇ ꜰɪʟᴇ ᴡɪʟʟ ɴᴏᴛ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ᴛʜᴇʀᴇ. \n\nकॉपीराइट के कारण यह मूवी फ़ाइल 𝟭𝟬 ⏳ मिनट में ऑटोमैटिक डिलीट हो जायेगी कृपया इस मूवी फ़ाइल को किसी फ्रैंड ⏩ या Saved Message folder में forward करे । फिर वहां से मूवी डाउनलोड ⚡ करना शुरू करें। फिर वहा पर मूवी फाइल ऑटोमैटिक डिलीट नही होगी ।e</i></b>",quote=True)
    await asyncio.sleep(600)
    await msg.delete()
    await k.edit_text("<b>Your File/Video is successfully deleted!!!\n\nClick below button to get your deleted file 👇</b>",reply_markup=InlineKeyboardMarkup(btn))
    return   
...
async def shortlink(bot, message):
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete....</code></b>")
...
async def removetutorial(bot, message):
    ...
    await reply.edit_text(f"<b>Successfully Removed Your Tutorial ✅✅....!!!</b>")
