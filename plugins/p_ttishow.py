...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
                    InlineKeyboardButton('🤖 🄾🅃🄷🄴🅁 🄱🄾🅃🅂 🤖', url="https://t.me/cinewood_1_bot?start"),
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def disable_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('CONTACT ME', url='https://t.me/cinewood_1')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        await bot.send_message(
            chat_id=chat_, 
...
@Client.on_message(filters.command('dbinfo') & filters.incoming)
async def get_ststs(bot, message):
    rju = await message.reply('Loading....')
